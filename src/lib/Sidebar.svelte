...
<aside class={dmEnabled ? "dark-mode" : ''}>
  <a href='/{username}/settings'>
    <img src={avatar ? getUserAvatar(id, avatar) : `https://ui-avatars.com/api/?name=${name}&background=random`} alt="Your profile" />
  </a>
  <div id="options-container">
    <a href='/{username}/feed'>
    ...
    <a href='/{username}/saved'>
      ...
      {:else}
        <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke-width="1.5" stroke={dmEnabled ? "white" : "black"}>
